...
function Home() {
    ...
    const [filter, setFilter] = useState({ location: "", minPrice: "", maxPrice: "", bedrooms: "", type: "" });
            ...
            <div className="hero-section">
                ...
                {!token ? (
                    ...
                    <div className="search-filters">
                        ...
                        <input type="number" placeholder="Max Price" name="maxPrice" value={filter.maxPrice} onChange={(e) => setFilter({ ...filter, maxPrice: e.target.value })} />
